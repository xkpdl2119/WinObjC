...
std::string GetWRLTypeNameForContainerTemplates(std::shared_ptr<ClangObjectModel::TypeInfo> typeInfo, bool interfaceType=true, bool baseType=true);
...
const std::map<std::string, ContainerTypeInfo> ContainerTypeMap = {
    { "NSSet", {"NSSet",
               "IIterable",
               "ConvertToIterable",
