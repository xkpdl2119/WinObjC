...
std::vector<std::string> getStringBetweenSymbols(const std::string& value, const char startSymbol, const char endSymbol, bool findLastOfEndSymbol = false);
...
static std::string addSeparators(const Container& data, const TransformFn& transform, const std::string& separator = ", ",
