...
namespace ContainerTemplates {
    ...
    std::string _generateObjCWrapperMethodDefinitionsForNSDictionaryKeyEnumerator(std::shared_ptr<ClangObjectModel::HeterogeneousContainerInfo> info);
    std::string generateObjCMarshallingMethods(std::shared_ptr<ClangObjectModel::ComponentInfo> comp);
    std::string _generateObjCMarshallingForPropertyValueTypes(std::set<std::shared_ptr<ClangObjectModel::TypeInfo>, ClangObjectModel::TypeInfo> types,
    ...
    std::string _generateRTMarshallingForPropertyValueTypes(std::set<std::shared_ptr<ClangObjectModel::TypeInfo>, ClangObjectModel::TypeInfo> types,
        std::string objectName);
    std::string _generateRTMarshallingForInterfaceTypes(std::shared_ptr<ClangObjectModel::TypeInfo> typeInfo,
        std::string objectName);
    std::string _generateRTMarshallingForContainerTypes(std::shared_ptr<ClangObjectModel::TypeInfo> typeInfo,
        std::string objectName);
}