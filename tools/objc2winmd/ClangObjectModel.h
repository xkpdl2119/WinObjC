...
public:
    ...
    void updateObjCCreatorFunctionName(std::string methodName, const std::shared_ptr<ClangObjectModel::TypeInfo>& typeInfo, std::string removeMethod = "");
...
struct ParameterInfo : public Symbol {
    ...
    static std::shared_ptr<ClangObjectModel::ParameterInfo> CloneParameterInfo(const std::shared_ptr<ClangObjectModel::ParameterInfo>& info);
};
...
public:
    ...
    PropertyInfo(const std::string& propertyName, const std::string& getterName, const std::string& setterName, std::shared_ptr<ClangObjectModel::MetaDataComments> metaData);
...
struct AsyncClassInfo {
    ...
    bool operator() (const std::shared_ptr<ClangObjectModel::AsyncClassInfo>& info1, const std::shared_ptr<ClangObjectModel::AsyncClassInfo>& info2) const;

    static std::shared_ptr<ClangObjectModel::AsyncClassInfo> CloneAsyncClassInfo(const std::shared_ptr<ClangObjectModel::AsyncClassInfo>& info);
};
...
struct InterfaceInfo : public Symbol {
    ...
    InterfaceInfo(const std::string& name, const std::string& winrtName, const std::string& idlRuntimeClassName, const std::string& idlFileName) : 
...
struct ComponentInfo : public Symbol, public std::enable_shared_from_this<ComponentInfo> {
    ...
    std::map<std::string, std::shared_ptr<HeterogeneousContainerInfo>>::iterator
        getHeterogeneousContainerInfo(std::shared_ptr<ClangObjectModel::TypeInfo> typeInfo);
    void clearAll();
