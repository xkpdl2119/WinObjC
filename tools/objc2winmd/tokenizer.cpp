...
void tokenize ( const string& str, T& result,
         ...
         const string& esc, bool saveQuotedEscapes,
         bool saveEmptyTokens, bool trimTokens )
{
...
template void tokenize<vector<string> > ( const string& str, vector<string>& result,
         const string& delimiters, const string& delimiters_preserve,
         const string& quote, const string& quote_preserve,
         const string& esc, bool saveQuotedEscapes,
         bool saveEmptyTokens , bool trimTokens );

template void tokenize<list<string> > ( const string& str, list<string>& result,
         const string& delimiters, const string& delimiters_preserve,
         const string& quote, const string& quote_preserve,
         const string& esc, bool saveQuotedEscapes,
         bool saveEmptyTokens, bool trimTokens );